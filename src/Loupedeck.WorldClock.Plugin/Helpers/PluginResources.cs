namespace Loupedeck.WorldClock
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Loupedeck.WorldClock.Plugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Loupedeck.WorldClock.Plugin.Resources.Resource.txt`.
